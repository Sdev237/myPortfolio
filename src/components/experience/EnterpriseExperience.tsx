  ...
  const company = [
    {
      ...
      poste: "Programmer Analyst",
      date: "2022-2023",
    },
    {
      name: "Hugo Company LTD",
      logo: "../app/fonts/hugo.png",
      poste: "IT Infrastructure Manager",
      date: "2020-2022",
    },
    {
      name: "CENADI",
      logo: "https://i0.wp.com/www.cenadi.cm/wp-content/uploads/2020/09/armoiries_logo_cenadi.png?fit=180%2C80&amp;ssl=1",
