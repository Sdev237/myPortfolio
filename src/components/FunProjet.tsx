...
const ActivityItem = ({ activity, isLast }: { activity: ContributionActivity, isLast: boolean }) => (
  <div className="activity-item">
    ...
    <div className="activity-menu">
      <svg aria-label="Collapse" className="octicon octicon-fold action-icon" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true" fill="#a8c2ab">
